...
public class CmdUtil
{
	...
	public final static String CLIENT_APP_TYPE_PHONE = "1";
	public final static String CLIENT_APP_TYPE_PAD = "2";
	public final static String CLIENT_APP_TYPE_MOBILE_HD = "HD";
...
//	public static final String NEW_SKIN_VERSION_PATH = FileUtil.getUpdatePath() + File.separator + CmdUtil.NEW_SKIN_VERSION_NAME;
