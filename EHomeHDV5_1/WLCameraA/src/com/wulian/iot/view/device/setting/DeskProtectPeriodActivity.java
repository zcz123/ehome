...
/**
 * @author hxc
 * @ClassName: DeskProtectPeriodActivity
 * @Function: 防护时间选择
 * @Date: 2016 11 28
 */
public class DeskProtectPeriodActivity extends SimpleFragmentActivity implements
        OnClickListener {
    ...
    public void root() {
        super.root();
        setContentView(R.layout.activity_desk_protect_period);
        initViews();
        initListeners();
        initData();
    }
    ...
    private void initViews() {
        ((TextView) findViewById(R.id.titlebar_title)).setText(getResources().getString(R.string.protect_time));
                        ...
                        if (id == R.id.btn_positive) {
                            ...
                            if (time.length == 4) {
                                ...
                                if (Integer.parseInt(time[0]) > Integer.parseInt(time[2])
                                        ...
                                        .parseInt(time[3]))) {
                                    CustomToast.show(DeskProtectPeriodActivity.this, R.string.protect_time_invalid);
                                    return;
                                }
                            }
