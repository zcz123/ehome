...
public class VCalendar extends ViewFlipper implements android.view.GestureDetector.OnGestureListener{

	public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#ffffff"); // 星期标题背景颜色
	public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#709e18"); // 星期标题文字颜色
	...
	public static final int COLOR_TX_THIS_DAY = Color.parseColor("#709e18"); // 当天日历数字颜色
	...
	private String[] weekday = new String[] {
			getResources().getString(R.string.week_sun),
			getResources().getString(R.string.week_mon),
			getResources().getString(R.string.week_tue),
			getResources().getString(R.string.week_wed),
			getResources().getString(R.string.week_thu),
			getResources().getString(R.string.week_fri),
			getResources().getString(R.string.week_sat) }; // 星期标题
	...
	public VCalendar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
