...
/**
 * @ClassName: FunctionActivity
 * @Function: 功能介绍
 * @Date: 2014年12月19日
 * @author Wangjj
 * @email wangjj@wuliangroup.cn
 */
public class FunctionIntroActivity extends BaseHelpActivity {
	...
	protected void initTitle() {
		tv_titlebar_title.setText(R.string.help_function_intor);
	};
	@Override
