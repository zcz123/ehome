 ...
 */
public class ImageResizer extends ImageWorker {//仅使用内存缓存
	...
	private Bitmap processBitmap(String pathname) {
		return decodeSampledBitmapFromFile(pathname, mImageWidth, mImageHeight,
				getImageCache());
	}
