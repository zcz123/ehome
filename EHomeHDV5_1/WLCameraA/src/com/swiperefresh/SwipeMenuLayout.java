...
public class SwipeMenuLayout extends FrameLayout {
	...
	private IsMenuOpenCallback isMenuOpenCallback;
	
	public void setMenuOpenCallback(IsMenuOpenCallback isMenuOpenCallback){
		this.isMenuOpenCallback = isMenuOpenCallback;
	}
	...
	public void smoothCloseMenu() {
		...
		Log.v("swipmenulayout", "smoothclosemenu");
		if(isMenuOpenCallback!=null){
			isMenuOpenCallback.isMenuOpen(false);
		}
		postInvalidate();
	}
	...
	public void smoothOpenMenu() {
		...
		Log.v("swipmenulayout", "smoothopenmenu");
		if(isMenuOpenCallback!=null){
			isMenuOpenCallback.isMenuOpen(true);
		}
		postInvalidate();
	}
