...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF1096D9;
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 15;//间隙高度

	/** Text size */
	private static final int TEXT_SIZE = 45;

	/** top和bottom的padding设置?*/
	
	/** Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET = TEXT_SIZE / 1+2;

	/** Additional width for items layout default 10*/
	private static final int ADDITIONAL_ITEMS_SPACE = 10;

	/** Label offset  default 8*/
	private static final int LABEL_OFFSET = 4;

	/** Left and right padding value  default 10*/
	private static final int PADDING = 1;

	/** Default count of visible items ,需为奇数*/
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundResource(R.drawable.wheel_bg);//滚轮背景
	}
