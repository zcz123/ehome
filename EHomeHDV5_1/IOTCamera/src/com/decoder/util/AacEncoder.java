...
public class AacEncoder {
	...
	public native static int AACEncoderOpen(int sampleRate, int channels); 
	// 第一个存储空间会自动释放。
    public native static int AACEncodeing(byte[] paramArrayOfByte1, int BufferSize,byte[] paramArrayOfByte2, int[] paramArrayOfByte3); 
	public native static int AACWrite(byte[] paramArrayOfByte1, int BufferSize);
	public native static int AACEncoderClose();
	public native static int testByte(byte[] paramArrayOfByte1);
