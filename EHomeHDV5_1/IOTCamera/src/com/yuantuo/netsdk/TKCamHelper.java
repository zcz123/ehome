...
public class TKCamHelper extends Camera implements com.tutk.IOTC.IRegisterIOTCListener {
	...
	public TKCamHelper(String name, String uid, String acc, String pwd) {
		mName = name;
		mUID = uid;
		mAcc = acc;
		mPwd = pwd;
	...
	public void camIndex(int mCamIndex){
		super.camIndex(mCamIndex);
	}
	
	@Override
	public void connect(String uid,int connectMode) {
		// TODO Auto-generated method stub
		super.connect(uid,connectMode);
		mUID = uid;
	}
