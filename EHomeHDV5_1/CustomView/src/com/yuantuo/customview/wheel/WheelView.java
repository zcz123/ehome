...
public class WheelView extends View
{
	...
	/** Text size */
	public int TEXT_SIZE = TEXT_SIZE_DEFAULT;
	...
	// Text paints
	protected TextPaint itemsPaint;
	protected TextPaint valuePaint;

	// Layouts
	protected StaticLayout itemsLayout;
	protected StaticLayout labelLayout;
	protected StaticLayout valueLayout;
	...
	{
		int size = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, TEXT_SIZE, getContext()
	...
	public void setTextSize(int size){
		...
		if (valuePaint != null && itemsPaint != null){
