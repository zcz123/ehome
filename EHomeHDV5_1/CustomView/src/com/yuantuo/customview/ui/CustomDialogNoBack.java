...
public class CustomDialogNoBack extends Dialog
{
	public static Set<CustomDialogNoBack> mDialogManagerSet = new HashSet<CustomDialogNoBack>();
	...
	public CustomDialogNoBack( Context context )
	{
		super(context);
	}

	public CustomDialogNoBack( Context context, int theme )
	{
		super(context, theme);
	}
	...
	public static class Builder
	{
		...
		public CustomDialogNoBack create( boolean cancelOnTouchOutSide, boolean hasFramework ){
			LayoutInflater inflater = (LayoutInflater) mContext
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

			int theme = hasFramework ? R.style.dialogStyle_Alarm : R.style.customDialogNoBack;
			CustomDialogNoBack dialog = new CustomDialogNoBack(mContext, theme);
		...
		private void removeAllDialog( CustomDialogNoBack dialog ){
			if (mSingleton){
				final Set<CustomDialogNoBack> dialogSet = mDialogManagerSet;
				Iterator<CustomDialogNoBack> iterator = dialogSet.iterator();
				while (iterator.hasNext()){
					CustomDialogNoBack customDialog = iterator.next();
					try{
		...
		private void initDialogButton( final CustomDialogNoBack dialog, View layout, boolean hasFramework ){
		...
		private void initContentView( final CustomDialogNoBack dialog, View layout, boolean hasFramework ){
	...
	public static void showCustomDialog( Context context, Drawable icon, String title,
		...
		CustomDialogNoBack.Builder builder = new CustomDialogNoBack.Builder(context);
		...
		CustomDialogNoBack dialog = builder.create(cancelOutSide, hasFramework);
		try{
			dialog.show();
		}
		catch (Exception e){
	...
	public static void showCustomDialog( Context context, CharSequence[] mItems,
		...
		builder.setAutoDismiss(true);
		CustomDialogNoBack dialog = builder.create(cancelOutSide, false);
		try{
			dialog.show();
		}
		catch (Exception e){
