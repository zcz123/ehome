...
public class PullListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.pull_head_layout,
	...
	private void changeHeaderViewByState() {
		...
		case REFRESHING:// 正在刷新状态
			...
			tipsTextview
					.setText(getResources().getString(R.string.refresh_now));// 提示信息变成正在刷新...
	...
	public  String converTime(Date date) throws ParseException {
		...
		if(timeGap > 24 * 60 * 60 * 30){
			timeStr = timeGap / (24 * 60 * 60*30) + rs.getString(R.string.month_ago);
		}
		else if (timeGap > 24 * 60 * 60) {// 1天以上
			timeStr = timeGap / (24 * 60 * 60) + rs.getString(R.string.day_ago);

		} else if (timeGap > 60 * 60) {// 1小时-24小时
			timeStr = timeGap / (60 * 60) + rs.getString(R.string.hour_ago);
		} else if (timeGap > 60) {// 1分钟-59分钟
			timeStr = timeGap / 60 + rs.getString(R.string.min_ago);
		} else {// 1秒钟-59秒钟
			timeStr = rs.getString(R.string.just);
		}
		return timeStr;
	}
