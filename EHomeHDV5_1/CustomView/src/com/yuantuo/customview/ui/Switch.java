...
public class Switch extends CompoundButton
{
	...
	public void onMeasure( int widthMeasureSpec, int heightMeasureSpec ) {
		...
		mOnLayout = verifyLayout(mOnLayout, mTextOn);
		mOffLayout = verifyLayout(mOffLayout, mTextOff);
	...
	private Layout verifyLayout( Layout layout, CharSequence textSequence ) {
		if (layout == null) {
			layout = makeLayout(textSequence);
		}
		else {
			CharSequence oldText = layout.getText();
			if (!TextUtils.equals(oldText, textSequence)) {
				layout = makeLayout(textSequence);
			}
		}
		return layout;
	...
	/*
	 * @Override public void jumpDrawablesToCurrentState() { super.jumpDrawablesToCurrentState(); mThumbDrawable.jumpToCurrentState();
	 * mTrackDrawable.jumpToCurrentState(); }
	 */

	public void setCancelDrag( boolean canDrage ) {
		this.canDrag = canDrage;
	}
}
