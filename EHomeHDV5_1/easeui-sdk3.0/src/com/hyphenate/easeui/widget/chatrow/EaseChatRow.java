...
import com.hyphenate.easeui.utils.Preference;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        preference=Preference.getPreferences(context);
        initView();
    }
...
//        }
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            ...
            if(!preference.getUserNickName("wlcg"+EMClient.getInstance().getCurrentUser()).equals("")){
                EaseUserUtils.setUserNick(preference.getUserNickName("wlcg"+EMClient.getInstance().getCurrentUser()), usernickView);
                usernickView.setVisibility(View.VISIBLE);
            }else{
                usernickView.setVisibility(View.GONE);
            }
            ...
            if(!userNick.equals("noData")){
                EaseUserUtils.setUserNick(preference.getUserNickName(message.getFrom()), usernickView);
            }else{
                usernickView.setVisibility(View.GONE);
            }
        }
