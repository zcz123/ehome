...
public class EaseChatFragment extends EaseBaseFragment {
    ...
    protected static final int REQUEST_CODE_SELECT_VIDEO = 4;
    ...
    protected void initView() {
        ...
        preference=Preference.getPreferences(getContext());
        hideTitleBar();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) { 
            ...
            } else if (requestCode == REQUEST_CODE_SELECT_VIDEO) { // video
                if (data != null) {
    ...
    public void initNumber(boolean isAddNumber){
        if(!isAddNumber){
            number=0;
        }
