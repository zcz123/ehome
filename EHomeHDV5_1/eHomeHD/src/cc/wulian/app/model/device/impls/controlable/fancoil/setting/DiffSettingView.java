...
public class DiffSettingView extends LinearLayout{
	...
	private String[] tempArray = { "1℃", "1.5℃","2℃", "2.5℃", "3℃", "3.5℃", "4℃", "4.5℃", "5℃", "5.5℃",
...
//    private String tempValue;
	...
	public DiffSettingView(Context context) {
		...
		inflate(mContext, R.layout.device_floorwarm_diff_setting_dialog, this);
		mTempView = (WheelView) findViewById(R.id.diff_wheelView);
