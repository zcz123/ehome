...
public class LocationCityListAdapter extends WLBaseAdapter<LocationEntity> {
	
	public LocationCityListAdapter(Context context, List<LocationEntity> data) {
		super(context, data);
	}
	  ...
	  protected void bindView(Context context, View view, int position, LocationEntity item)
	  {
		  ...
		  itemName.setText(item.geteCityName());		 	  
	  }
}
