...
public class LinkTaskBodyLightView extends AbstractLinkTaskView{
	...
	public LinkTaskBodyLightView(BaseActivity context, TaskInfo info) {
		super(context, info);
	}
	...
	private void changeTextView(){
		...
		if(values >= 0 && values <= 10){
			valuedegreeText.setText(context.getString(R.string.device_security_light_1));
		}else if(values > 10 && values <= 150){
			valuedegreeText.setText(context.getString(R.string.device_link_task_sensor_degree_in));
		}else if(values > 150 && values <= 750){
			valuedegreeText.setText(context.getString(R.string.device_link_task_sensor_degree_general));
		}else if(values > 750 && values <= 1000){
			valuedegreeText.setText(context.getString(R.string.device_link_task_sensor_degree_instrong));
		}else if(values > 1000 && values <= 3000){
			valuedegreeText.setText(context.getString(R.string.device_security_light_4));
		}else{
