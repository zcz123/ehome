...
public class SensorAirChooseView {
	...
	public SensorAirChooseView(Context context, final String epType) {
		...
		valueLessText.setText("PPM");
		valueMoreText.setText("PPM");
		valueLessEditText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(4)});
		valueMoreEditText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(4)});
