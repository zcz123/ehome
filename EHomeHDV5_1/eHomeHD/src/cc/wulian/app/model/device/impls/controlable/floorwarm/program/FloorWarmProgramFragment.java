...
public class FloorWarmProgramFragment extends WulianFragment implements View.OnClickListener ,ICommand406_Result {
	...
	@ViewInject(R.id.floorwarm_program_monday)
	private TextView btnMonday;
	@ViewInject(R.id.floorwarm_program_tuesday)
	private TextView btnTuesday;
	@ViewInject(R.id.floorwarm_program_wednesday)
	private TextView btnWednesday;
	@ViewInject(R.id.floorwarm_program_thursday)
	private TextView btnThursday;
	@ViewInject(R.id.floorwarm_program_friday)
	private TextView btnFriday;
	@ViewInject(R.id.floorwarm_program_saturday)
	private TextView btnSaturday;
	@ViewInject(R.id.floorwarm_program_sunday)
	private TextView btnSunday;
	@ViewInject(R.id.floorwarm_program_cancel)
	private ImageButton btnCancel;
	@ViewInject(R.id.floorwarm_program_copy)
	private Button btnCopy;
	@ViewInject(R.id.floorwarm_program_sync)
	private TextView btnSync;
	@ViewInject(R.id.floorwarm_programView)
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initBar();
		Bundle bundle = getArguments().getBundle("FloorWarmProgramFragmentInfo");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.device_floorwarm_program, container, false);
	...
	public void onClick(View v) {
		switch (v.getId()){
			case R.id.floorwarm_program_monday:
				...
				break;
			case R.id.floorwarm_program_tuesday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_wednesday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_thursday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_friday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_saturday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_sunday:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_cancel:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_copy:
				if(programView.isBallChanged()){
				...
				break;
			case R.id.floorwarm_program_sync:
				showSyncDialog();
				break;
		}
	...
	private void sync(){
		...
		String sendCmd = FloorWarmUtil.PROGRAM_CMD_TAG + mMode.substring(1,2) + dataCmd;
	...
	private void showResetResultDialog(){
		if(StringUtil.equals(mEpData, FloorWarmUtil.PROGRAM_TAG)){
	...
	private void handleResult406(String reciveData) {
		try {
			...
			if (jsonObject.has("programData")) {
				...
				if (StringUtil.equals(tag, FloorWarmUtil.PROGRAM_CMD_TAG)) {
