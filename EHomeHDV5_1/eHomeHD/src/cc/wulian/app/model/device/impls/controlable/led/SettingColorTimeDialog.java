...
public class SettingColorTimeDialog extends LinearLayout{
	...
	public SettingColorTimeDialog(Context context) {
		super(context);
		this.mContext = context;
		inflate(mContext, R.layout.device_led_bright_setting_layout2, this);
		mMs = (WheelView) findViewById(R.id.colortime_wheel2);
		mSeconds = (WheelView) findViewById(R.id.colortime_wheel1);
