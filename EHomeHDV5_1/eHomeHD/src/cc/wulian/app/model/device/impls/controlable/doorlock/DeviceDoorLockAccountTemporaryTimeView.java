...
public class DeviceDoorLockAccountTemporaryTimeView extends LinearLayout {
	...
	private String[] dayArray = { "01", "02", "03", "04", "05", "06", "07",
			...
			"30", "31" };
	private String[] hoursArray = {  "01", "02", "03", "04", "05", "06",
	...
	public DeviceDoorLockAccountTemporaryTimeView(Context context) {
		super(context);
		this.mContext = context;
		inflate(mContext,
				R.layout.device_door_lock_account_temporary_end_time_view,
				this);
		for (int i = 0; i < 31; i++) {
			yearArray[i] = String.valueOf(2016 + i);
		}
		...
		int hourNumber=calendar.get(Calendar.HOUR_OF_DAY);
		int miniteNumber=calendar.get(Calendar.MINUTE);
		mYears.setSelection(yearNumber-2016, true);
		mMonths.setSelection(monthNumber, true);
		mDays.setSelection(dayNumber-1, true);
		mHours.setSelection(hourNumber-1, true);
		mMins.setSelection(miniteNumber, true);
