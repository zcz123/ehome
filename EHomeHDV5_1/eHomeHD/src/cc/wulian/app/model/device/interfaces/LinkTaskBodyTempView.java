...
public class LinkTaskBodyTempView extends AbstractLinkTaskView{
	...
	public LinkTaskBodyTempView(BaseActivity context, TaskInfo info) {
		super(context, info);
	}
	...
	private View createLinkView() {
		...
		valuedegreeText.setVisibility(View.INVISIBLE);
