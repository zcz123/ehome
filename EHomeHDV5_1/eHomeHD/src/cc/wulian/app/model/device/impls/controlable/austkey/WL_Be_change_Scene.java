...
@DeviceClassify(devTypes = { "Be" }, category = Category.C_OTHER)
public class WL_Be_change_Scene extends AbstractAustKeyDevice {
    private static final String[] EP_LIGHT = { EP_14 };
    private static final String[] EP_SEQUENCE = { EP_15 };
    private static String CMD_OPEN = "100";
    ...
    public WL_Be_change_Scene(Context context, String type) {
        super(context, type);
    }
    ...
    public String[] getSceneSwitchEPNames() {
        String ep15Name = getResources().getString(cc.wulian.app.model.device.R.string.device_bind_scene);
    ...
    public String[] getSwitchEPName() {
        ...
        if (StringUtil.isNullOrEmpty(ep14Name)) {
            ep14Name = getResources().getString(
                    cc.wulian.app.model.device.R.string.device_type_14);
        }
    ...
    public CharSequence parseDataWithProtocol(String epData) {
        ...
        sb.append(getResources().getString(cc.wulian.app.model.device.R.string.device_type_14));
        return sb.toString();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle saveState) {
        return inflater.inflate(cc.wulian.app.model.device.R.layout.device_aus_dimming_light, null);
    }

    @Override
    public void onViewCreated(View view, Bundle saveState) {
        getBindScenesMap();
        sceneLineLayout = (LinearLayout)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_scene_ll);
        sceneImageView = (ImageView)view.findViewById(cc.wulian.app.model.device.R.id.device_aust_scene_iv);
        seekBarCircle = (SeekCircle)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_dimming_light_sc);
        onTextView = (TextView)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_on_tv);
        offTextView = (TextView)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_off_tv);
        processTextView = (TextView)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_process_tv);
        sceneTextView = (TextView)view.findViewById(cc.wulian.app.model.device.R.id.device_aus_scene_tv);
        sceneLineLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(info != null){
                    ...
                    WLToast.showToast(mContext, getString(cc.wulian.app.model.device.R.string.device_no_bind_scene), WLToast.TOAST_SHORT);
                }
            }
        });
        seekBarCircle.setOnSeekCircleChangeListener(new SeekCircle.OnSeekCircleChangeListener() {
            ...
            public void onStopTrackingTouch(SeekCircle seekCircle) {
                ...
                controlDevice(EP_14, device.getDeviceInfo().getDevEPInfo().getEpType(), StringUtil.appendLeft((int)(process/100.0*100)+"", 3, '0'));
            }
    ...
    public void initViewStatus() {
        ...
        if(info != null){
            ...
            sceneTextView.setText(cc.wulian.app.model.device.R.string.device_no_bind_scene);
        }
        WulianDevice device = getChildDevice(EP_14);
        if(isOpened()){
            onTextView.setVisibility(View.GONE);
        ...
        seekBarCircle.setProgress((int)(StringUtil.toInteger(device.getDeviceInfo().getDevEPInfo().getEpData(), 16)/100.0*100));
    }
