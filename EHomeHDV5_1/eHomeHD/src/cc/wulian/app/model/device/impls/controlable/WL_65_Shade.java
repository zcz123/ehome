 ...
 * 1:停,2:开,3:关
 */
@DeviceClassify(devTypes = { ConstUtil.DEV_TYPE_FROM_GW_SHADE }, category = Category.C_CONTROL)
public class WL_65_Shade extends ControlableDeviceImpl {
	...
	public WL_65_Shade(Context context, String type) {
		super(context, type);
	}
