...
public class LocationProvinceListAdapter extends WLBaseAdapter<LocationEntity> {
	
	public LocationProvinceListAdapter(Context context, List<LocationEntity> data) {
		super(context, data);
	}
	  ...
	  protected void bindView(Context context, View view, int position, LocationEntity item)
	  {
		  TextView itemName=(TextView) view.findViewById(R.id.location_item_name_tv);
		  itemName.setText(item.geteProvince());		 	  
	  }
}
