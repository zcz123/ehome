...
public class FloorWarmProgressBar extends View {
	...
	public FloorWarmProgressBar(Context context) {
		super(context);
		init(context);

	}

	public FloorWarmProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public FloorWarmProgressBar(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context) {
		...
		mThumbPaint.setColor(Color.parseColor("#ec7016"));
