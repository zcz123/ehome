...
public class ProjectorRemoteControlFragment extends WulianFragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parentView = inflater.inflate(R.layout.fragment_projector_remootecontrol,
				container, false);
		return parentView;
	}
	...
	public void onResume() {
		...
		if(uei_edit_save.equals("1")){
			ProjectorRemoteControlFragment.this.getActivity().finish();
		}
	}
...
//		getSupportActionBar().setIconText(getString(R.string.nav_device_title));
				...
				getSupportActionBar().setRightMenuClickListener(new OnRightMenuClickListener() {
					...
					public void onClick(View v) {
						if(WL_23_IR_Control.isUsePlugin){
							getPlugin("NormalLearn_Project.html");
						}else {
							String strUri = "file:///android_asset/uei/NormalLearn_Project.html";
	...
	private LinearLayout lin_projector_expand;
	private void initView(View paramView) {
		lin_projector_expand=(LinearLayout) paramView.findViewById(R.id.lin_projector_expand);
		lin_projector_expand.setOnClickListener(this);
		lin_projector_expand.setEnabled(false);
		...
		if(this.args_value.getViewMode()==0){
			virkeyBtn.setTVLight((ImageView) paramView.findViewById(R.id.iv_projector_light));
		}else{
			paramView.findViewById(R.id.iv_projector_light).setVisibility(View.GONE);
		}
	...
	public void onClick(View view) {
		switch (view.getId()){
		case R.id.lin_projector_expand:
			expandPopupWindow.showAtLocation(parentView.findViewById(R.id.lin_projector), Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
			break;
		}
	}
