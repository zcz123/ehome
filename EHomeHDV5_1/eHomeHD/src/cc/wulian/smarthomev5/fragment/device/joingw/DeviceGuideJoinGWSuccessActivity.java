...
public class DeviceGuideJoinGWSuccessActivity extends EventBusActivity implements OnClickListener  {
	...
	public void jumpToConfigDeviceActivity(String gwID, String devID) {
		...
		intent.setClass(DeviceGuideJoinGWSuccessActivity.this,
