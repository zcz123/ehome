...
public class ListViewSwipeGestureForMonitor implements OnTouchListener {
    Activity activity;
    ...
    public ListViewSwipeGestureForMonitor(ListView listView, TouchCallbacks Callbacks, Activity context){
    ...
    private void GetResourcesValues() {
        ...
        FullColor           =   activity.getResources().getString(R.string.nav_home_title);         //Orange
        HalfText            =   activity.getResources().getString(R.string.nav_home_title);
        HalfTextFinal         =   activity.getResources().getString(R.string.nav_home_title);
        FullText            =   activity.getResources().getString(R.string.nav_home_title);
        FullTextFinal         =   activity.getResources().getString(R.string.nav_home_title);
...
//                     ResetListItem(mDownView);
    ...
    private void SetBackGroundforList() {
		// TODO Auto-generated method stub
         ...
         RelativeLayout.LayoutParams lp1 =new RelativeLayout.LayoutParams(textwidth22, RelativeLayout.LayoutParams.WRAP_CONTENT);
         ...
         if(SwipeType==Double){
             ...
             RelativeLayout.LayoutParams lp2 =new RelativeLayout.LayoutParams(textwidth22,android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT);
