...
public class DoorLockSceneInfoAdapter extends SceneInfoAdapter {
	...
	public DoorLockSceneInfoAdapter(BaseActivity context,ActionBarCompat actionBarCompat) {
		super(context);
	...
	protected void bindView(Context context, View view, int pos,
		...
		if(item.getSceneID().equals(EditDoorLock6SceneFragment.sceneId)){
			isUsing=true;
		}
		...
		public void onClick(View v) {
			...
			actionBarCompat.setRightMenuClickListener(new OnRightMenuClickListener() {
				...
				public void onClick(View v) {
					...
					String devID = EditDoorLock6SceneFragment.devID;
					String gwID = EditDoorLock6SceneFragment.gwID;
			...
			EditDoorLock6SceneFragment.sceneId=item.getSceneID();
