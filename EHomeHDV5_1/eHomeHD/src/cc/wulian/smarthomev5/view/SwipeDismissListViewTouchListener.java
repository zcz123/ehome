...
/**
 * A {@link View.OnTouchListener} that makes the list items in a {@link ListView} dismissable. {@link ListView} is given special treatment because by default it
 * handles touches for its list items... i.e. it's in charge of drawing the pressed state (the list selector), handling list item clicks, etc.
 * 
 * <p>
 * After creating the listener, the caller should also call {@link ListView#setOnScrollListener(AbsListView.OnScrollListener)}, passing in the scroll listener
 * returned by {@link #makeScrollListener()}. If a scroll listener is already assigned, the caller should still pass scroll changes through to this listener.
 * This will ensure that this {@link SwipeDismissListViewTouchListener} is paused during list view scrolling.
 * </p>
 * 
 * <p>
 * Example usage:
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener
{
	...
	/**
	 * The callback interface used by {@link SwipeDismissListViewTouchListener} to inform its client about a successful dismissal of one or more list item
	 * positions.
	 */
	 ...
	 * {@link ListView#setOnScrollListener(AbsListView.OnScrollListener)}. If a scroll listener is already assigned, the caller should still pass scroll changes
	 * through to this listener. This will ensure that this {@link SwipeDismissListViewTouchListener} is paused during list view scrolling.</p>
	 * 
			...
			case MotionEvent.ACTION_UP :
			{
				...
				if (dismiss){
					...
					ViewPropertyAnimator.animate(mDownView)
							.translationX(dismissRight ? mViewWidth : -mViewWidth).alpha(0)
