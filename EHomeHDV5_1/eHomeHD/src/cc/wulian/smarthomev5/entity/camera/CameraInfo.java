...
public class CameraInfo extends BaseCameraEntity{
	...
	//add syf eagle
	public static final int CAMERA_TYPE_EAGLE = 23;
	...
	public String gwId;
	public boolean isForSetting =false;
	...
	public CameraInfo( int camId, int camType, String camName, int iconId, String uid, String host, int port, String username, String password, int channel, String bindDev,
			String gwId )
	{
		this.camId = camId;
	...
	public CameraInfo( int camId, int camType, String camName, int iconId , String uid, String host, int port, String username, String password, int channel, int istream,
	...
	public  void setIsForSetting(boolean isForSetting){
