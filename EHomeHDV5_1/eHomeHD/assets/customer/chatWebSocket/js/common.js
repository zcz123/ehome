(function() {
	...
	var ehomev5 = {
		...
		uploadChatPic: function(filepath, successCallback, errorCallback) {
			var success = (typeof successCallback !== 'function' ? null : function(args) {
					successCallback(args);
				}),
				fail = (typeof errorCallback !== 'function' ? null : function(code) {
			...
			callbackID = plus.callbackUtil.getCallbackId(success, fail);
			return B.exec(_BARCODE, "uploadChatPic", JSON.stringify([callbackID, filepath]));
		},
		getLang: function() {
		...
		selectPhotoForCus: function(successCallback, errorCallback) {
			var success = (typeof successCallback !== 'function' ? null : function(args) {
				successCallback(args);
			});
			var fail = (typeof errorCallback !== 'function' ? null : function(code) {
			...
			var callbackID = plus.callbackUtil.getCallbackId(success, fail);
			return B.exec(_BARCODE, "selectPhotoForCus", JSON.stringify([callbackID]));
		},
		takePhotoForCus: function(successCallback, errorCallback) {
			var success = (typeof successCallback !== 'function' ? null : function(args) {
				successCallback(args);
			});
			var fail = (typeof errorCallback !== 'function' ? null : function(code) {
			...
			var callbackID = plus.callbackUtil.getCallbackId(success, fail);
			return B.exec(_BARCODE, "takePhotoForCus", JSON.stringify([callbackID]));
		},
